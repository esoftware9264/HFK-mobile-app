...
class AddProductFirstStepFrag : Fragment() {
    ...
    private fun initToolbarTitle() {
        addProductActivity.setToolbarTitle("Add Product")
    }
        ...
        if (isFirstStepFormValidated()) {
            /*getAddProductRequestModel()?.let { addProductRequestModel ->
                ...
                *//*addProductActivity.startFragment(
                    ...
                    AddProductSecondStepFrag.newInstance(addProductRequestModel)
                )*//*
            }*/
        }
    }
    ...
    companion object {
        fun newInstance(addProductRequestModel: AddProductRequestModel): AddProductFirstStepFrag {
            val mAddProductFirstStepFrag = AddProductFirstStepFrag()
            val bundle = Bundle()
