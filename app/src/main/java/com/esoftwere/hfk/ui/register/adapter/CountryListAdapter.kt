 ...
 */
class CountryListAdapter(val mContext: Context, private val itemList: ArrayList<CountryModel>?) : BaseAdapter()  {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
       var binding = DataBindingUtil.inflate(
        ...
        binding.txtDropDownLabel.text = itemList?.get(position)?.countryName
        return binding.root
    }
}