 ...
 */
class DistrictListAdapter(val mContext: Context, private val itemList: ArrayList<DistrictModel>?) : BaseAdapter()  {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
       var binding = DataBindingUtil.inflate(
        ...
        binding.txtDropDownLabel.text = itemList?.get(position)?.district
        return binding.root
    }
}