 ...
 */
class StateListAdapter(val mContext: Context, private val itemList: ArrayList<StateModel>?) : BaseAdapter()  {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
       var binding = DataBindingUtil.inflate(
        ...
        binding.txtDropDownLabel.text = itemList?.get(position)?.state
        return binding.root
    }
}