 ...
 */
class StateListMarketViewAdapter(
    val mContext: Context,
    private val itemList: ArrayList<StateModel>?
) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val stateItemModel: StateModel? = itemList?.get(position)

        stateItemModel?.let { stateItem ->
            binding.txtDropDownLabel.text = ValidationHelper.optionalBlankText(stateItem.state)
        }
